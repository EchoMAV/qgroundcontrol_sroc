...
Item {
    ...
    QGCToolInsets {
        ...
        rightEdgeCenterInset: (telemetryPanel.rightEdgeCenterInset
                               > photoVideoControl.rightEdgeCenterInset) ? telemetryPanel.rightEdgeCenterInset : photoVideoControl.rightEdgeCenterInset
    ...
    PhotoVideoControl {
        ...
        //state: _verticalCenter ? "verticalCenter" : "botAnchor"
        state: "botAnchor"
        states: [
            State {
                name: "verticalCenter"
    ...
    Loader {
        ...
        property real leftEdgeBottomInset: visible ? bottomEdgeLeftInset + width / 18
                                                     - ScreenTools.defaultFontPixelHeight * 2 : 0
        property real rightEdgeBottomInset: visible ? bottomEdgeRightInset + width / 18
                                                      - ScreenTools.defaultFontPixelHeight * 2 : 0
    }
    ...
    FlyViewToolStrip {
        ...
        onDisplayPreFlightChecklist: preFlightChecklistPopup.createObject(
                                         mainWindow).open()
