...
Rectangle {
    ...
    ColumnLayout {
        ...
        RowLayout {
            Layout.alignment: Qt.AlignHCenter
            spacing: 0
            visible: _showModeIndicator && !_mavlinkCamera
        ...
        Rectangle {
            ...
            color: _mavlinkCamera
                   && _mavlinkCamera.trackingEnabled ? qgcPal.colorRed : qgcPal.windowShadeLight
            width: ScreenTools.defaultFontPixelWidth * 6
            height: width
            radius: width * 0.5
            border.color: qgcPal.buttonText
        ...
        QGCPopupDialog {
            ...
            ColumnLayout {
                ...
                GridLayout {
                    ...
                    QGCLabel {
                        text: qsTr("video source used: HDMI ")
