...
#endif
    int rssi = (int)(int8_t)rstatus.rssi;
    int remrssi = (int)(int8_t)rstatus.remrssi;
    int lnoise = (int)(int8_t)rstatus.noise;
    int rnoise = (int)(int8_t)rstatus.remnoise;
...
void Vehicle::_loadJoystickSettings()
{
    ...
    if (_toolbox->joystickManager()->activeJoystick()) {
        ...
        if(joystickName=="Scuf Gaming SCUF Envision Controller" || joystickName == "Scuf Gaming SCUF Envision Pro Controller" || joystickName == "Kutta KTAC GC v1" || joystickName == "Kutta KTAC GC v2" || joystickName == "EchoMAV EchoControl")
        {
