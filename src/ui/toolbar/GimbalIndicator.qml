...
Item {
    ...
    property bool showIndicator: gimbalController
                                 && gimbalController.gimbals.count
    ...
    Component {
        ...
        Rectangle {
            ...
            GridLayout {
                ...
                QGCLabel {
                    text: qsTr("Gimbal ")
                          + (multiGimbalSetup ? activeGimbal.deviceId.rawValue : "") + qsTr(
                              "<br> Controls")
                ...
                Repeater {
                    ...
                    property var hasControl: gimbalController
                                             && gimbalController.activeGimbal
                                             && gimbalController.activeGimbal.gimbalHaveControl
                ...
                QGCButton {
                    ...
                    Rectangle {
                        ...
                        property var panelHeight: gimbalSelectorContentGrid.childrenRect.height
                                                  + margins * 2
                        ...
                        GridLayout {
                            ...
                            Repeater {
                                model: gimbalController
                                       && gimbalController.gimbals ? gimbalController.gimbals : undefined
                                delegate: QGCButton {
                                    Layout.preferredWidth: Layout.preferredHeight
                                    Layout.preferredHeight: buttonHeight
                                    Layout.alignment: Qt.AlignHCenter | Qt.AlignVCenter
                ...
                GridLayout {
                    ...
                    QGCLabel {
                        ...
                        visible: enableOnScreenControlCheckbox.checked
                                 && QGroundControl.settingsManager.gimbalControllerSettings.ControlType.rawValue === 0
                    }
                    FactTextField {
                    ...
                    FactCheckBox {
                        ...
                        text: "  " + qsTr(
                                  "Show gimbal Azimuth indicator in map")
                    ...
                    FactCheckBox {
                        ...
                        text: "  " + qsTr(
                                  "Use Azimuth instead of local yaw on top toolbar indicator")
    ...
    GridLayout {
        ...
        QGCLabel {
            id: statusLabel
            text: activeGimbal
                  && activeGimbal.retracted ? qsTr("Retracted") : (activeGimbal
