...
Item {
    ...
    Component {
        ...
        Rectangle {
            ...
            Column {
                ...
                QGCLabel {
                    id: gpsLabel
                    text: (QGroundControl.gpsRtk.active.value) ? qsTr("Survey-in Active") : qsTr(
                                                                     "RTK Streaming")
                ...
                GridLayout {
                    ...
                    QGCLabel {
                        ...
                        text: QGroundControl.gpsRtk.valid.value ? qsTr("Accuracy:") : qsTr(
                                                                      "Current Accuracy:")
                        visible: QGroundControl.gpsRtk.currentAccuracy.value > 0
                    }
                    QGCLabel {
                        text: QGroundControl.gpsRtk.currentAccuracy.valueString
    ...
    QGCColoredImage {
        ...
        opacity: 1
        color: QGroundControl.gpsRtk
               && QGroundControl.gpsRtk.active.value ? qgcPal.colorRed : qgcPal.buttonText
    }
    ...
    Column {
        ...
        QGCLabel {
            ...
            text: QGroundControl.gpsRtk ? QGroundControl.gpsRtk.numSatellites.value : "N/A"
        }
    }
