...
Item {
    ...
    property bool _requiresCalibration: !_activeJoystick.calibrated
                                        && !_buttonsOnly
    ...
    Column {
        ...
        GridLayout {
            ...
            //-- Enable Joystick
            QGCLabel {
                text: _requiresCalibration ? qsTr("Enable not allowed (Calibrate First)") : qsTr(
            ...
            QGCCheckBox {
                ...
                Connections {
                    ...
                    onActiveJoystickChanged: {
                        if (_activeJoystick) {
                            enabledSwitch.checked = Qt.binding(function () {
                                return _activeJoystick.calibrated
                                        && globals.activeVehicle.joystickEnabled
                            })
                        }
                    }
                }
            ...
            QGCComboBox {
                ...
                Component.onCompleted: {
                    var index = joystickCombo.find(
                                joystickManager.activeJoystickName)
                    if (index === -1) {
                        console.warn(qsTr("Active joystick name not in combo"),
                                     joystickManager.activeJoystickName)
                    } else {
        ...
        Row {
            ...
            Rectangle {
                ...
                GridLayout {
                    ...
                    anchors.centerIn: parent
                    QGCLabel {
                        text: globals.activeVehicle.sub ? qsTr(
                                                              "Lateral") : qsTr(
                                                              "Roll")
